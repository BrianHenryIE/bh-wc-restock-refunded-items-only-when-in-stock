<?php
/**
 * Tests for BH_WC_Restock_Refunded_Items_Only_When_In_Stock main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WC_Restock_Refunded_Items_Only_When_In_Stock_Integration_Test extends \Codeception\TestCase\WPTestCase {

	public function hooks() {
		$hooks = array(
			array( 'woocommerce_order_item_get__reduced_stock', Stock::class, 'filter_reduced_stock_meta' ),
		);
		return $hooks;
	}
